...
from isagog_docs.api.api import api_router # Import the combined API router
...
async def health_check():
    ...
    try:
        db = get_database()
        # Perform a simple operation to check connection, e.g., db.command('ping')
        mongo_ok = True
    except Exception:
        mongo_ok = False
    ...
    return {
        ...
        # "mongo_db_ok": mongo_ok, # Uncomment when MongoDB is fully integrated
